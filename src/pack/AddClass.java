...
public class AddClass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        //sets the text to each button and label
        ...
        //adds an action listener to use a method everytime the button is pressed
        ...
        //this arranges all the components
    ...
    /*
     * gets text input from the 3 text fields and adds a new class using the inputs
     * then clears the text fields
     */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        for(int i = 0;i<mainpageE.stud.size();i++) {
			if(mainpageE.stud.get(i).returnid()==(studentpage.std.returnid())) {
				mainpageE.stud.get(i).addClass(a, c, b);
			}
		}
